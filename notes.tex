...
\begin{document}
    ...
    \chapter{Example: Classifying Clothing}
        \section{Featurizing and learning}
            \begin{figure}[h]
                \centering
                \includegraphics[height=3.2cm]{yo-15-0012-soft-10}
                \includegraphics[height=3.2cm]{yo-15-0012-soft-100}
                \includegraphics[height=3.2cm]{yo-15-0012-soft-1000}
                \includegraphics[height=3.2cm]{yo-15-0012-soft-10000}
                \\
                \includegraphics[height=3.2cm]{yo-15-0012-hard-10}
                \includegraphics[height=3.2cm]{yo-15-0012-hard-100}
                \includegraphics[height=3.2cm]{yo-15-0012-hard-1000}
                \includegraphics[height=3.2cm]{yo-15-0012-hard-10000}
                \caption{\emph{
                    Polynomial features allow decision boundaries to exhibit
                    peninsulas, channels, and islands.
                }}
        ...
        \section{Seeing overfitting}
            ...
            \begin{figure}[h]
                \centering
                \includegraphics[height=3.2cm]{yo-03-0012-hard-10000}
                \includegraphics[height=3.2cm]{yo-03-0096-hard-10000}
                \includegraphics[height=3.2cm]{yo-15-0012-hard-10000}
                \includegraphics[height=3.2cm]{yo-15-0096-hard-10000}
                \caption{\emph{
                    Polynomial features allow decision boundaries to exhibit
                    peninsulas, channels, and islands.
                }}
            ...
            \begin{figure}[h]
                \centering
                \includegraphics[height=4.2cm]{yoyo-15-0012}
                \includegraphics[height=4.2cm]{yoyoyo-0012}
                \caption{\emph{
                    Polynomial features allow decision boundaries to exhibit
                    peninsulas, channels, and islands.
                }}
