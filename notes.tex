    ...
    \chapter{Example: Classifying Clothing}
        \section{Featurizing and learning}
            \begin{figure}[h]
                ...
                \caption{\emph{
                    Here, we train a $d=28$ model on $N=15$ datapoints for
        ...
        \section{Seeing overfitting}
            ...
            \begin{figure}[h]
                ...
                \caption{\emph{
                    ...
                    \textbf{Left column}: $N=2$.
                    \textbf{Right column}: $N=64$.
            ...
            \begin{figure}[h]
                \centering
                \includegraphics[height=5.2cm]{yoyo-28-0016}
                \includegraphics[height=5.2cm]{yoyoyo-0016}
                \caption{\emph{
                    \textbf{Left}: 
