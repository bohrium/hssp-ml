...
\begin{document}
    ...
    \chapter{Example: Classifying Clothing}
        \section{Featurizing and learning}
            \begin{figure}[h]
                \centering
                \includegraphics[height=4.2cm]{yo-28-0012-soft-10}
                \includegraphics[height=4.2cm]{yo-28-0012-soft-1000}
                \includegraphics[height=4.2cm]{yo-28-0012-soft-10000}
                \\
                \includegraphics[height=4.2cm]{yo-28-0012-hard-10}
                \includegraphics[height=4.2cm]{yo-28-0012-hard-1000}
                \includegraphics[height=4.2cm]{yo-28-0012-hard-10000}
                \caption{\emph{
                    Here, we train a $d=28$ model on $N=12$ datapoints for
                    (from left to right) $10^1$, $10^3$, or $10^4$ many
        ...
        \section{Seeing overfitting}
            ...
            \begin{figure}[h]
                \centering
                \includegraphics[height=4.2cm]{yo-02-0012-hard-10000}
                \includegraphics[height=4.2cm]{yo-02-0096-hard-10000} \\
                \includegraphics[height=4.2cm]{yo-28-0012-hard-10000}
                \includegraphics[height=4.2cm]{yo-28-0096-hard-10000}
                \caption{\emph{
                    A $d=2$ model (top) is simple enough to generalize well from
                    scarce data (top left), but too simple to fit a large 
                    ...
                    \textbf{Left column}: $N=12$.
                    \textbf{Right column}: $N=96$.
            ...
            \begin{figure}[h]
                \centering
                \includegraphics[height=5.2cm]{yoyo-28-0012}
                \includegraphics[height=5.2cm]{yoyoyo-0012}
                \caption{\emph{
                    \textbf{Left}: 
                    ...
                    complex and thus better able to overfit to data.  Thus, 
                    the training error decreases even as the test error 
                    increases past $d=4$.
                    Here, $N=12$.
                    %
